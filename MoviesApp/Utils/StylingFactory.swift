...
// Source: https://github.com/marinbenc/UIView-Styling/blob/master/UIView-Styling.playground/Contents.swift
...
struct Style {
    static let defaultBackgroundViewStyle: UIViewStyle<UIView> = UIViewStyle { view in
